...
def test_uninstall_app_tethysapp(mocker, caplog):
    ...
    mock_mamba_uninstall = mocker.patch('tethysapp.app_store.uninstall_handlers.mamba_uninstall')
...
def test_uninstall_app_proxyapp(mocker):
    mock_sn = mocker.patch('tethysapp.app_store.uninstall_handlers.send_uninstall_messages')
    mock_delete_proxy_app = mocker.patch('tethysapp.app_store.uninstall_handlers.delete_proxy_app')
    mock_mamba_uninstall = mocker.patch('tethysapp.app_store.uninstall_handlers.mamba_uninstall')
    mock_channel = MagicMock()
    mock_workspace = MagicMock()
    ...
    expected_uninstall_data['app_name'] = expected_uninstall_data['name'].replace("proxyapp_", "")
...
def test_uninstall_app_proxyapp_PackagesNotFoundError(mocker):
    ...
    mock_clear_github_cache_list = mocker.patch('tethysapp.app_store.uninstall_handlers.clear_github_cache_list')
